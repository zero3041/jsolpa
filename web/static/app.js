...
(() => {
  ...
  function activateTab(tabId) {
    if (!new Set(['mailread', 'eventista', 'vote', 'change-email', 'settings']).has(tabId)) tabId = 'mailread';
  ...
  function initTabs() {
    ...
    if (!new Set(['mailread', 'eventista', 'vote', 'change-email', 'settings']).has(initialTab)) initialTab = 'mailread';
